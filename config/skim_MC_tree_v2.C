...
void skim_data_tree_v2 (TString year = "2022EE"){

  TString path = "/eos/cms/store/group/phys_higgs/cmshzz4l/cjlst/RunIII_byZ1Z2/240820/"+year+"/Data";
  ...
  oldtree->SetBranchStatus("ZZyAbs", 1);
  oldtree->SetBranchStatus("Z1Mass",1);
  oldtree->SetBranchStatus("Z2Mass",1);
  oldtree->SetBranchStatus("ZZEta",1);

  TString newpath = "/eos/cms/store/group/phys_higgs/cmshzz4l/cjlst/RunIII_byZ1Z2/240820/"+year+"/Data";
