...
def impactPlots():
    ...
    if opt.PHYSICSMODEL=='v3':
        ...
        # plot
        for obsBin in range(nBins-1):
            cmd = 'plotImpacts.py -i impacts_v3_'+obsName+'_'
            if (not opt.UNBLIND): cmd = cmd + 'asimov.json -o impacts_v3_'+obsName+'_r_smH_' + obsName + '_' + str(obsBin) +'_asimov --POI r_smH_' + obsName + '_' + str(obsBin)
            elif (opt.UNBLIND): cmd = cmd + 'data.json -o impacts_v3_'+obsName+'_r_smH_' + obsName + '_' + str(obsBin) +'_data --POI r_smH_' + obsName + '_' + str(obsBin)
            print '---------------------------'
            print cmd, '\n'
            print '---------------------------'
            cmds.append(cmd)
            ...
            if (not opt.UNBLIND): cmd = cmd + 'asimov.json -o impacts_skimmed_v3_'+obsName+'_r_smH_' + obsName + '_' + str(obsBin) +'_asimov --POI r_smH_' + obsName + '_' + str(obsBin)
            elif (opt.UNBLIND): cmd = cmd + 'data.json -o impacts_skimmed_v3_'+obsName+'_r_smH_' + obsName + '_' + str(obsBin) +'_data --POI r_smH_' + obsName + '_' + str(obsBin)
            print '---------------------------'
            print cmd, '\n'
            print '---------------------------'
            cmds.append(cmd)
        ...
        for obsBin in ['2e2muBin0','4eBin0','4muBin0']:
            ...
            cmd = 'plotImpacts_skimmed.py -i impacts_v2_'
