...
for fState in fStates:
    ...
    for recobin in range(lenObsBins):
        ...
        for genbin in range(lenObsBins):
            ...
            VBFxs_allgen += higgs_xs['VBFH_125.0']*higgs4l_br['125.0_'+fState]*acc['VBFH125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(genbin)]
        ...
        for genbin in range(lenObsBins):
            ...
            VBFxs = higgs_xs['VBFH_125.0']*higgs4l_br['125.0_'+fState]*acc['VBFH125_'+fState+'_'+obsName+'_genbin'+str(genbin)+'_recobin'+str(genbin)]
